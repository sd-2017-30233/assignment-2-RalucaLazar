...
*/
        ...
        //Report r = rp.makeReport("CSV","csvreport");
        //r.generateReport();
        //bs.sellBook("Pride and prejudice","Jane Austen");
        //bs.addBook("Sense and sensibility","Jane Austen","romance","10","20");
        //bs.viewBook("1");
        //bs.viewBooks();
        //bs.updateBook("1","50","50");
        //bs.deleteBook("4");
        //es.addEmployee("Lazar Raluca","raluca","raluca");
        //es.deleteEmployee("4");
        //es.viewEmployee("3");
        //es.updateEmployee("1","popescu","popescu");
       // for(int i=0;i<books.size();i++)
          //  System.out.println(books.get(i).getAuthor()+" "+books.get(i).getPrice());
    }
